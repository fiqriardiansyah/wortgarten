    ...
    <Card index={index}>
      ...
      <div className="hidden lg:flex items-start justify-between gap-4">
        <div className="flex items-start gap-3">
          ...
          <div>
            <h3 className="font-bold text-deep">New story ready: '{title}'</h3>
      ...
      <div className="flex items-center gap-3 lg:hidden">
        <div className="flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-full bg-lilac">
          <BookOpen size={18} className="text-primary" />
        </div>
        <div className="min-w-0 flex-1">
          <p className="truncate font-semibold text-deep text-sm">New story: '{title}'</p>
